...
#pragma warning restore 618
									...
									case Translations.Command.MiscSpeed:
										...
										else
										{
											...
											if ((int)Renderer.OptionSpeed >= 3)
											{
												Renderer.OptionSpeed = 0;
											}
										}
										break;
									case Translations.Command.MiscGradient:
										...
										else
										{
											...
											if ((int)Renderer.OptionGradient >= 4)
											{
												Renderer.OptionGradient = 0;
											}
										}
										break;
									case Translations.Command.MiscDistanceToNextStation:
										...
										else
										{
											...
											if ((int)Renderer.OptionDistanceToNextStation >= 3)
											{
												Renderer.OptionDistanceToNextStation = 0;
											}
										}
										break;
