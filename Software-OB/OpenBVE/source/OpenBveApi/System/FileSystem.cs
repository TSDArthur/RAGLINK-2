...
namespace OpenBveApi.FileSystem
{
    ...
    public class FileSystem
    {
        ...
        public static FileSystem FromCommandLineArgs(string[] args)
        {
            ...
            string configFile = Path.CombineDirectory(RAGLINKCommons.RPlatform.SettingsContent.settingsPath, "FileSystem.cfg");
        ...
        public void SaveCurrentFileSystemConfiguration()
        {
            ...
            RAGLINKCommons.RPlatform.SettingsContent.UpdateSettingsPath();
            string file = Path.CombineDirectory(RAGLINKCommons.RPlatform.SettingsContent.settingsPath, "FileSystem.cfg");
        ...
        internal static string ReplacePath(string line)
        {
            try
            {
                ...
                line = line.Replace(RAGLINKCommons.RPlatform.SettingsContent.packagePath, "$[RAGLINKPackage]");
                line = line.Replace(RAGLINKCommons.RPlatform.SettingsContent.settingsPath, "$[RAGLINKSettings]");
            }
            catch
            {
            }
        ...
        private static string GetAbsolutePath(string folder, bool checkIfRooted)
        {
            ...
            folder = folder.Replace("$[RAGLINKPackage]", RAGLINKCommons.RPlatform.SettingsContent.packagePath);
            folder = folder.Replace("$[RAGLINKSettings]", RAGLINKCommons.RPlatform.SettingsContent.settingsPath);
