    ...
    public class CommunicationSerial
    {
        ...
        static public class StreamRecord
        {
            ...
            static public void InsertRecievedStream(string dataStream)
            {
                ...
                if (boardStreamCombined.Count == recordLimit)
                {
                    Clear();
                }
            ...
            static public void InsertSentStream(string dataStream)
            {
                ...
                if (boardSentStreamRecord.Count == recordLimit)
                {
                    Clear();
                }
        ...
        static public class BoardStreamCommonFunctions
        {
            ...
            static public void SendSpecialData(int dataNum)
            {
                try
                {
                    if (serialList[0] == null || !BoardsManager.boardInfo.boardFileLoaded)
                    {
                        return;
                    }
                    ...
                    {
                        sendData += (char)BoardsManager.boardInfo.COMM_SPEC_SYMBOL;
                    }
        ...
        static public bool InitializeSerial()
        {
            ...
            try
            {
                if (!BoardsManager.boardInfo.boardFileLoaded || !ProjectsManager.projectInfo.fileLoaded)
                {
                    return retValue;
                }
