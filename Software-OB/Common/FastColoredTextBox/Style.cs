...
namespace FastColoredTextBoxNS
{
    ...
    public abstract class Style : IDisposable
    {
        ...
        public abstract void Draw(Graphics gr, Point position, Range range, int cntChinese = 0);
    ...
    public class WavyLineStyle : Style
    {
        ...
        public override void Draw(Graphics gr, Point pos, Range range, int cntChinese = 0)
        {
