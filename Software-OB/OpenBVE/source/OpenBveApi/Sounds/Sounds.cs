...
namespace OpenBveApi.Sounds
{
    ...
    public class Sound
    {
        ...
        public static bool operator ==(Sound a, Sound b)
        {
            ...
            if (a.MySampleRate != b.MySampleRate)
            {
                return false;
            }

            if (a.MyBitsPerSample != b.MyBitsPerSample)
            {
                return false;
            }

            if (a.MyBytes.Length != b.MyBytes.Length)
            {
                return false;
            }
            ...
            {
                if (a.MyBytes[i].Length != b.MyBytes[i].Length)
                {
                    return false;
                }
                ...
                {
                    if (a.MyBytes[i][j] != b.MyBytes[i][j])
                    {
                        return false;
                    }
                }
        ...
        public override bool Equals(object obj)
        {
            ...
            Sound x = (Sound)obj;
            if (this.MySampleRate != x.MySampleRate)
            {
                return false;
            }

            if (this.MyBitsPerSample != x.MyBitsPerSample)
            {
                return false;
            }

            if (this.MyBytes.Length != x.MyBytes.Length)
            {
                return false;
            }
            ...
            {
                if (this.MyBytes[i].Length != x.MyBytes[i].Length)
                {
                    return false;
                }
                ...
                {
                    if (this.MyBytes[i][j] != x.MyBytes[i][j])
                    {
                        return false;
                    }
                }
