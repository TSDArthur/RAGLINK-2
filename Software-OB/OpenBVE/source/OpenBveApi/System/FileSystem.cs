...
namespace OpenBveApi.FileSystem {
	...
	public class FileSystem {
		...
		public static FileSystem FromCommandLineArgs(string[] args) {
			...
			string configFile = Path.CombineDirectory(RAGLINKCommons.RAGLINKPlatform.SettingsContent.settingsPath, "FileSystem.cfg");
		...
		public void SaveCurrentFileSystemConfiguration()
		{
			...
			RAGLINKCommons.RAGLINKPlatform.SettingsContent.UpdateSettingsPath();
			string file = Path.CombineDirectory(RAGLINKCommons.RAGLINKPlatform.SettingsContent.settingsPath, "FileSystem.cfg");
		...
		internal static string ReplacePath(string line)
		{
			try
			{
				...
				line = line.Replace(RAGLINKCommons.RAGLINKPlatform.SettingsContent.packagePath, "$[RAGLINKPackage]");
				line = line.Replace(RAGLINKCommons.RAGLINKPlatform.SettingsContent.settingsPath, "$[RAGLINKSettings]");
			}
			catch
			{
			}
		...
		private static string GetAbsolutePath(string folder, bool checkIfRooted) {
			...
			folder = folder.Replace("$[RAGLINKPackage]", RAGLINKCommons.RAGLINKPlatform.SettingsContent.packagePath);
			folder = folder.Replace("$[RAGLINKSettings]", RAGLINKCommons.RAGLINKPlatform.SettingsContent.settingsPath);
